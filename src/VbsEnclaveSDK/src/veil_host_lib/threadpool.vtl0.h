    ...
    private:
        void thread_proc()
        {
            while (true)
            {
                ...
                THROW_IF_FAILED(veil::vtl0::enclave::implementation::call_enclave_function(m_enclave, export_ordinals::EnclaveImplementationFramework_Vtl1_Threadpool_RunTask, data));
            }
        }
