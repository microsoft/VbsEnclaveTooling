...
{
    veil::vtl1::vtl0_functions::internal::debug_print(L"DEBUG: create_user_bound_key - Function entered");
    ...
    try
    {
        ...
        veil::vtl1::vtl0_functions::internal::debug_print(L"DEBUG: create_user_bound_key - Generated user key bytes");
