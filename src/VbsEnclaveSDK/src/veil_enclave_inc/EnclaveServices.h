...
// HACKHACK: This is a workaround for the fact that Gudge couldn't get the normal VFS
// (enclavevfs_normal.vcxproj) to build when referencing the CPP runtime version that
// provides enclaveium.h.
#ifdef VFS_NORMAL
typedef void* PTRUSTLET_BINDING_DATA;
#else
...
/// <summary>
/// Returns an implementation of <see cref="IEnclaveServices" /> that mocks necessary Windows APIs.
/// </summary>
/// <returns>An instance of <see cref="IEnclaveServices" /> that mocks necessary Windows APIs</returns>
IEnclaveServices& GetMockEnclaveServices();
