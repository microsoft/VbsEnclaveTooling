...
pub mod fb_generated {
    ...
    impl_flatbuffer_pack!(
        flatbuffer_test::NestedDataT,
        flatbuffer_test::NestedData<'a>
    );
    impl_flatbuffer_pack!(flatbuffer_test::AllTypesT, flatbuffer_test::AllTypes<'a>);
    impl_flatbuffer_pack!(
        flatbuffer_test::TestFuncArgsT,
        flatbuffer_test::TestFuncArgs<'a>
    );
    impl_flatbuffer_pack!(
        flatbuffer_test::TestFuncArgs2T,
        flatbuffer_test::TestFuncArgs2<'a>
    );
}
...
pub mod dev_types {
    ...
    // Simulates a function struct generated by edlcodgen.exe
    #[derive(Debug, Clone, PartialEq, Default, EdlDerive)]
    #[target_struct(flatbuffer_test::TestFuncArgsT)]
    pub struct TestFuncArgs {
        #[boxed_target]
    ...
    // Simulates a function struct generated by edlcodgen.exe
    #[derive(Debug, Clone, PartialEq, Default, EdlDerive)]
    #[target_struct(flatbuffer_test::TestFuncArgs2T)]
    pub struct TestFuncArgs2 {
        pub return_val: String,
    }
}
