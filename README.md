...
Once you have built the `CodeGenerator` and `SDK` nuget packages, you can add them directly to your own visual studio
...
1. Install them both your in enclave project and your hostApp project. 
