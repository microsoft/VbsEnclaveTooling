...
SignVerifyConfig InitializeUserBindingConfig(bool& areUserBindingApisAvailable)
{
    SignVerifyConfig config;
    config.helloKeyName = KEY_NAME;
    config.pinMessage = L"Please enter your PIN to access the signature key.";
